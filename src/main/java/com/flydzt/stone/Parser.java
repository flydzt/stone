...
import com.flydzt.stone.ast.ASTLeaf;
import com.flydzt.stone.ast.ASTList;
...
public class Parser {
    ...
    protected static class IdToken extends AToken {
        ...
        protected IdToken(Class<? extends ASTLeaf> type, Set<String> reserved) {
            super(type);
    ...
    protected class NumToken extends AToken {
